...
public class ChatBuilder {
	...
	public ChatBuilder chatClient() {
		if (!isEmpty())
			sendClient(this);
		return this;
	}

	public ChatBuilder chatPlayer(final @Nonnull ICommandSender target) {
		if (!isEmpty())
			sendPlayer(target, this);
		return this;
	}

	public ChatBuilder chatServer() {
		if (!isEmpty())
			sendServer(this);
		return this;
	}
	...
	@SideOnly(Side.CLIENT)
	public static void sendClient(final @Nonnull ChatBuilder chat) {
