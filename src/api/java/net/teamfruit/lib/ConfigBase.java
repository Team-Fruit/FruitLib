...
public final class ConfigBase extends Configuration {
    private final
    @Nonnull
    Set<IReloadableConfig> configs = Sets.newHashSet();
    ...
    public
    @Nonnull
    <T extends IReloadableConfig> T registerReload(final @Nonnull T config) {
    ...
    public
    @Nonnull
    ConfigProperty<String> propertyString(final @Nonnull Property property) {
        return registerReload(ConfigProperty.propertyString(this, property));
    }

    public
    @Nonnull
    ConfigProperty<Boolean> propertyBoolean(final @Nonnull Property property) {
        return registerReload(ConfigProperty.propertyBoolean(this, property));
    }

    public
    @Nonnull
    ConfigProperty<Double> propertyDouble(final @Nonnull Property property) {
        return registerReload(ConfigProperty.propertyDouble(this, property));
    }

    public
    @Nonnull
    ConfigProperty<Integer> propertyInteger(final @Nonnull Property property) {
    ...
    public static abstract class ConfigProperty<E> implements IReloadableConfig {
        ...
        public
        @Nonnull
        ConfigProperty<E> setListener(@Nullable final ConfigListener<E> listener) {
        ...
        public
        @Nonnull
        ConfigProperty<E> setComment(final @Nonnull String comment) {
        ...
        public abstract
        @Nonnull
        ConfigProperty<E> set(@Nonnull E value);

        public abstract
        @Nonnull
        ConfigProperty<E> reset();

        public static
        @Nonnull
        ConfigProperty<String> propertyString(final @Nonnull ConfigBase config, final @Nonnull Property property) {
            return new StringConfigProperty(config, property);
        }

        public static
        @Nonnull
        ConfigProperty<Boolean> propertyBoolean(final @Nonnull ConfigBase config, final @Nonnull Property property) {
            return new BooleanConfigProperty(config, property);
        }

        public static
        @Nonnull
        ConfigProperty<Double> propertyDouble(final @Nonnull ConfigBase config, final @Nonnull Property property) {
            return new DoubleConfigProperty(config, property);
        }

        public static
        @Nonnull
        ConfigProperty<Integer> propertyInteger(final @Nonnull ConfigBase config, final @Nonnull Property property) {
        ...
        private static class StringConfigProperty extends ConfigProperty<String> {
            ...
            public
            @Nonnull
            StringConfigProperty set(final @Nonnull String value) {
        ...
        private static class BooleanConfigProperty extends ConfigProperty<Boolean> {
            ...
            public
            @Nonnull
            BooleanConfigProperty set(final @Nonnull Boolean value) {
                this.property.set(value);
                setProp(value);
                this.config.save();
                return this;
        ...
        private static class DoubleConfigProperty extends ConfigProperty<Double> {
            ...
            public
            @Nonnull
            DoubleConfigProperty set(final @Nonnull Double value) {
                this.property.set(value);
                setProp(value);
                this.config.save();
                return this;
        ...
        private static class IntegerConfigProperty extends ConfigProperty<Integer> {
            ...
            public
            @Nonnull
            IntegerConfigProperty set(final @Nonnull Integer value) {
                this.property.set(value);
                setProp(value);
                this.config.save();
                return this;
